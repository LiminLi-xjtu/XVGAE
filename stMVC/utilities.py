...
def parameter_setting():
	...
	shuj="151507"
	BasePath    = 'E:\\pycode\\XVGAE\\data\\'+shuj
	parser.add_argument('--shuj', default=shuj)
	...
	parser.add_argument('--cluster_pre', '-clup', type=int, default=16, help='predefined cluster for scRNA')
	...
	parser.add_argument('--batch_size_I', '-bI', type=int, default=12, help='Batch size for spot image data')
